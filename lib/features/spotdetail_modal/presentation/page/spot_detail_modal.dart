  ...
  static const List<_StatusSectionData> _sections = <_StatusSectionData>[
    _StatusSectionData(
      ...
      options: <_StatusOptionData>[
        _StatusOptionData(id: 'PLEASANT', title: '혼잡도 낮음'),
        _StatusOptionData(id: 'GOOD_FOR_TRAINING', title: '훈련하기 좋음'),
        _StatusOptionData(id: 'GOOD_FOR_FILMING', title: '촬영하기 좋음'),
      ],
    ),
    _StatusSectionData(
      title: '주의 필요',
      ...
      options: <_StatusOptionData>[
        ...
        _StatusOptionData(id: 'GUARD_ENFORCED', title: '경비 단속'),
        _StatusOptionData(id: 'DARK_AT_NIGHT', title: '야간 어두움'),
        _StatusOptionData(id: 'FILMING_RESTRICTED', title: '촬영 제지 있음'),
        _StatusOptionData(id: 'BEWARE_COMPLAINTS', title: '민원주의'),
      ],
    ),
    _StatusSectionData(
      title: '접근 불가/위험',
      ...
      options: <_StatusOptionData>[
        _StatusOptionData(id: 'DAMAGED_STRUCTURE', title: '구조물 파손'),
        _StatusOptionData(id: 'UNDER_CONSTRUCTION', title: '공사 중'),
        _StatusOptionData(id: 'ACCESS_CONTROLLED', title: '출입 통제'),
        _StatusOptionData(id: 'FACILITY_CHANGED', title: '시설 변경됨'),
      ],
    ),
  ];
