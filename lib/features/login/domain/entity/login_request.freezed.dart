...
mixin _$LoginRequest {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, deviceToken, nickname);

  @override
  String toString() {
    return 'LoginRequest(deviceToken: $deviceToken, nickname: $nickname)';
  }
}
...
abstract mixin class $LoginRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String deviceToken, String nickname});
}
...
extension LoginRequestPatterns on LoginRequest {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String deviceToken, String nickname)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _LoginRequest() when $default != null:
        return $default(_that.deviceToken, _that.nickname);
      case _:
        return orElse();
    }
  }
...
class _LoginRequest implements LoginRequest {
  const _LoginRequest({required this.deviceToken, required this.nickname});
