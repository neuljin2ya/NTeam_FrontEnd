...
@ProviderFor(addSpotStatusUseCase)
final addSpotStatusUseCaseProvider = AddSpotStatusUseCaseProvider._();

final class AddSpotStatusUseCaseProvider extends $FunctionalProvider<
    AddSpotStatusUseCase,
    AddSpotStatusUseCase,
    AddSpotStatusUseCase> with $Provider<AddSpotStatusUseCase> {
  AddSpotStatusUseCaseProvider._()
      : super(
          from: null,
          argument: null,
          retry: null,
          name: r'addSpotStatusUseCaseProvider',
          isAutoDispose: true,
          dependencies: null,
          $allTransitiveDependencies: null,
        );
  ...
  @override
  String debugGetCreateSourceHash() => _$addSpotStatusUseCaseHash();

  @$internal
  @override
  $ProviderElement<AddSpotStatusUseCase> $createElement(
          $ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  AddSpotStatusUseCase create(Ref ref) {
    return addSpotStatusUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(AddSpotStatusUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<AddSpotStatusUseCase>(value),
    );
  }
}

String _$addSpotStatusUseCaseHash() =>
    r'd9a573ff8c38265357604c6ebf9042d461babe74';
