...
GoRouter goRouter(Ref ref) => GoRouter(
  ...
  routes: <GoRoute>[
    ...
    GoRoute(
      ...
      builder: (BuildContext context, GoRouterState state) => const NewSpotPage(),
    ),
    GoRoute(
      path: SGRoute.newSpotAddress.route,
      builder: (BuildContext context, GoRouterState state) => const NewSpotAddressPage(),
    ),
    GoRoute(
    ...
    GoRoute(
      ...
      builder: (BuildContext context, GoRouterState state) {
        ...
        final List<String> selectedStatusIds = extra is List<String>
            ? extra
            : const <String>[];
