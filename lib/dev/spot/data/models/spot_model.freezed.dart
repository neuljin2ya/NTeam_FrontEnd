...
mixin _$SpotModel {
  ...
  @override
  String toString() {
    return 'SpotModel(spotId: $spotId, name: $name, captionImgUrl: $captionImgUrl, latitude: $latitude, longitude: $longitude, mainAddress: $mainAddress, subAddress: $subAddress, difficulty: $difficulty, description: $description, features: $features, statuses: $statuses, createdAt: $createdAt)';
  }
}
