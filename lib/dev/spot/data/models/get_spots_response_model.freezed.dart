...
abstract mixin class $GetSpotsResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String code, String message, List<SpotModel>? data});
}
...
extension GetSpotsResponseModelPatterns on GetSpotsResponseModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String code, String message, List<SpotModel>? data)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _GetSpotsResponseModel extends GetSpotsResponseModel {
  const _GetSpotsResponseModel(
      {required this.code, required this.message, final List<SpotModel>? data})
      : _data = data,
        super._();
