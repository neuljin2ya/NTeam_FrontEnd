...
mixin _$Spot {
  ...
  @override
  String toString() {
    return 'Spot(spotId: $spotId, name: $name, captionImgUrl: $captionImgUrl, latitude: $latitude, longitude: $longitude, mainAddress: $mainAddress, subAddress: $subAddress, difficulty: $difficulty, description: $description, features: $features, statuses: $statuses, createdAt: $createdAt)';
  }
}
